...
import blogContentRoutes from "./routes/blogContentRoutes.js";
...
import simulationConfigRoutes from "./routes/simulationConfigRoutes.js";
...
app.use("/api/simulation-configs", simulationConfigRoutes);
...
import certificateSignatureRoutes from "./routes/certificateSignatureRoutes.js";
app.use("/api/invoice-company-settings", invoiceCompanySettingsRoutes);
app.use("/api/certificate-signatures", certificateSignatureRoutes);

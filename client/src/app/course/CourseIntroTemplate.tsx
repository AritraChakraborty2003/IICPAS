    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-[1440px] px-6 py-16 sm:px-10 lg:px-16">
            <div className="grid gap-10 border border-slate-200 bg-[#f8fbf9] p-8 lg:grid-cols-[0.9fr_1.1fr] lg:p-12">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#067647]">
                  Contact IICPA
                </p>
                ...
                <p className="mt-5 max-w-xl text-base leading-8 text-slate-600 sm:text-lg">
                  Contact IICPA for course guidance, fee details, admission support, and counseling. Our team can help you choose the right program based on your background, goals, and job profile.
                </p>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  <Link
                    href="/register"
                    className="inline-flex items-center justify-center rounded-full border border-slate-300 px-7 py-3.5 text-sm font-semibold text-slate-900 transition hover:bg-slate-100"
                  >
                    Apply Now
                  </Link>
                </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="border-l-4 border-[#3cd664] bg-white px-6 py-5 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Call for admission counseling and course information.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-[#3cd664] bg-white px-6 py-5 shadow-sm">
                  ...
                  <p className="mt-3 text-xl font-semibold text-slate-900 break-all">
                    iicpaconnect@gmail.com
                  </p>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Share your query for admission, eligibility, or support.
                  </p>
                </div>

                <div className="border-l-4 border-[#3cd664] bg-white px-6 py-5 shadow-sm sm:col-span-2">
                  <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">
                    Address
                  </p>
                  <p className="mt-3 text-base leading-7 text-slate-700">
                    Office 55,56,57, 10th Floor I-thum's Galleria Mall Alpha-II Commercial Belt, Block I, Sector Alpha II, Greater Noida, Brahmpur Rajraula Urf Nawada, Uttar Pradesh 201310
                  </p>
                </div>
              </div>
            </div>

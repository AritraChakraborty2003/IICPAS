...
interface GSTR1A16SimulationProps {
  onComplete?: () => void;
}

// /simulations/gst/gstr-1a-16 -> gst-gstr-1a-16 (matches the slug derivation
...
const SIMULATION_SLUG = "gst-gstr-1a-16";
...
export default function GSTR1A16Simulation({
  onComplete,
}: GSTR1A16SimulationProps = {}) {
